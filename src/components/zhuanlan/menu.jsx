...
class ZlMenu extends React.Component {
    ...
    render() {
        let homeMainLeftTwodiv1 = { float: "right" }
                ...
                <div className="homeMain">
                    <div className="homeMainLeft">
                        <div className="homeMainLeft-two" style={homeMainLeftTwoStyle}>
                            <div style={homeMainLeftTwoH}>原创文章</div>
                        ...
                        <div className="homeMainLeft-three">
                            <ZlEvery tab={this.state.EveryParamsTab} sort={this.state.EveryParamsSort}/>
                        </div>
                    </div>
